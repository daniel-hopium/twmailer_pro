...
$(OBJ_DIR)twmailer-server.o: $(SRC_DIR)twmailer-server.cpp $(INC_DIR)encryption.h $(INC_DIR)ldap_authentication.h $(INC_DIR)blacklist.h
	$(CC) $(CFLAGS) -c -o $@ $< -I$(INC_DIR) 
...
$(OBJ_DIR)blacklist.o: $(SRC_DIR)blacklist.cpp $(INC_DIR)blacklist.h
	$(CC) $(CFLAGS) -c -o $@ $< -I$(INC_DIR)
